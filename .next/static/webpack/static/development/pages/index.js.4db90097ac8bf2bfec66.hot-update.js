...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api */ "./api/api.ts");
...
var CharityApi = {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function all$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_api__WEBPACK_IMPORTED_MODULE_1__["default"].get("/charities"));

          case 2:
            resp = _context.sent;
            return _context.abrupt("return", resp.data.Charities);
  ...
  one: function one(id) {
    var resp;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function one$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_api__WEBPACK_IMPORTED_MODULE_1__["default"].get("/charity/" + id));

          case 2:
            resp = _context2.sent;
            return _context2.abrupt("return", resp.data.Charity);
...
//# sourceMappingURL=index.js.4db90097ac8bf2bfec66.hot-update.js.map